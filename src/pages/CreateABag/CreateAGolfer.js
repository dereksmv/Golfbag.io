...
export default class CreateAGolfer extends Component {
    constructor(props) {
        ...
        handleSubmit(e) {
            ...
            let fileinput = document.getElementById("player_image").files[0];
            ...
            formdata.append("sponsorship", this.state.sponsorship);
        ...
        return (
            <div className="container mx-auto">
                <form method="post" onSubmit={(e) => {this.handleSubmit(e)}}>
                    ...
                    label="Sponsors"
                    id="sponsorship"
                    placeholder="Enter this player's sponsorship"
                    onChange={(e) => {this.handleChange(e)}}
                    />
                    <InputTextOption
                    id="tour"
                    options={["PGA Tour", "PGA European Tour", "LPGA Tour", "Ladies European Tour", "PGA Tour Champions"]}
                    label="Tour"
                    name="tour"
                    defaultText="Please select a tour"
                    onChange={(e) => {this.handleChange(e)}}
                    />
                    <InputNumber
                    name="rank"
