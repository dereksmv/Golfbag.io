...
class MainNav extends React.Component {
    render() {
        return(
            ...
            <div class="fixed w-full bottom-0 flex justify-center shadow-lg bg-gradient-to-t from-gray-100 to to-transparent">
                ...
                <div class="absolute flex flex-row justify-between bottom-0 w-full">
                    <div class="flex bg-white justify-center items-center w-20 h-20 border-t-2 border-green-300">
